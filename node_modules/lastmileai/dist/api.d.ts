import { CreateChatCompletionRequest as OpenAICreateChatCompletionRequest, CreateChatCompletionResponse as OpenAICreateChatCompletionResponse, CreateCompletionRequest as OpenAICreateCompletionRequest, CreateCompletionResponse as OpenAICreateCompletionResponse } from "openai";
 ...
 */
export interface EmbeddingCollectionListQueryData extends CommonListQueryDataWithSearch {
    /**
 ...
 */
export interface NotificationListQueryData extends CommonListQueryDataWithSearch {
}
/**
 ...
 */
export interface OrganizationListQueryData extends CommonListQueryDataWithSearch {
}
/**
 ...
 */
export declare enum TrialState {
    OPEN = "OPEN",
    CLOSED = "CLOSED"
}
/**
...
export declare class LastMile {
     ...
     */
    createDataset(data: DatasetCreateData): Promise<CreateDatasetResponse>;
    /**
     *
     ...
     */
    listDatasets(queryData?: DatasetListQueryData): Promise<ListDatasetsResponse>;
    /**
     *
     * @summary Reads a Dataset
     * @param {string} id The id of the Dataset to read
     */
    readDataset(id: string): Promise<ReadDatasetResponse>;
    /**
     *
     ...
     */
    updateDataset(id: string, data: DatasetUpdateData): Promise<UpdateDatasetResponse>;
    /**
     * EMBEDDINGS
     */
    /**
     ...
     */
    createEmbeddingCollection(data: EmbeddingCollectionCreateData): Promise<CreateEmbeddingCollectionResponse>;
    /**
     *
     * @summary Deletes a specified EmbeddingCollection
     * @param {string} id The id of the EmbeddingCollection to delete
     */
    deleteEmbeddingCollection(id: string): Promise<{
        status: string;
    }>;
    /**
     *
     ...
     */
    listEmbeddingCollections(queryData?: EmbeddingCollectionListQueryData): Promise<ListEmbeddingCollectionsResponse>;
    /**
     *
     * @summary Reads an EmbeddingCollection
     * @param {string} id The id of the EmbeddingCollection to read
     */
    readEmbeddingCollection(id: string): Promise<ReadEmbeddingCollectionResponse>;
    /**
     *
     ...
     */
    embeddingCollectionStatus(id: string): Promise<EmbeddingCollectionStatusResponse>;
    /**
     *
     ...
     */
    updateEmbeddingCollection(id: string, data: EmbeddingCollectionUpdateData): Promise<UpdateEmbeddingCollectionResponse>;
    /**
     * EXPERIMENTS
     */
    /**
     ...
     */
    createExperiment(data: ExperimentCreateData): Promise<CreateExperimentResponse>;
    /**
     *
     ...
     */
    listExperiments(queryData?: ExperimentListQueryData): Promise<ListExperimentsResponse>;
    /**
     *
     * @summary Reads an Experiment
     * @param {string} id The id of the Experiment to read
     */
    readExperiment(id: string): Promise<ReadExperimentResponse>;
    /**
     *
     ...
     */
    updateExperiment(id: string, data: ExperimentUpdateData): Promise<UpdateExperimentResponse>;
    /**
     * INFERENCE
     */
    /**
     ...
     */
    createOpenAIChatCompletion(data: OpenAIChatCompletionData): Promise<OpenAICreateChatCompletionResponse>;
    /**
     *
     ...
     */
    createOpenAICompletion(data: OpenAICompletionData): Promise<OpenAICreateCompletionResponse>;
    /**
     * MODELS
     */
    /**
     ...
     */
    createModel(data: ModelCreateData): Promise<CreateModelResponse>;
    /**
     *
     ...
     */
    listModels(queryData?: ModelListQueryData): Promise<ListModelsResponse>;
    /**
     *
     * @summary Reads a Model
     * @param {string} id The id of the Model to read
     */
    readModel(id: string): Promise<ReadModelResponse>;
    /**
     *
     ...
     */
    updateModel(id: string, data: ModelUpdateData): Promise<UpdateModelResponse>;
    /**
     * NOTIFICATIONS
     */
    /**
     ...
     * @param {ModelListQueryData} [queryData] Query / pagination filters
     */
    listNotifications(queryData?: NotificationListQueryData): Promise<ListNotificationsResponse>;
    /**
     *
     ...
     */
    updateNotificationRead(id?: string, all?: boolean): Promise<{
        status: string;
    }>;
    /**
     * ORGANIZATIONS
     ...
     */
    createOrganization(data: OrganizationCreateData): Promise<CreateOrganizationResponse>;
    /**
     *
     ...
     */
    listOrganizations(queryData?: OrganizationListQueryData): Promise<ListOrganizationsResponse>;
    /**
     *
     * @summary Reads an Organization
     * @param {string} id The id of the Organization to read
     */
    readOrganization(id: string): Promise<ReadOrganizationResponse>;
    /**
     *
     ...
     */
    updateOrganization(id: string, data: OrganizationUpdateData): Promise<UpdateOrganizationResponse>;
    /**
     ...
     */
    acceptOrganizationInvite(id: string): Promise<{
        status: string;
    }>;
    /**
     *
     ...
     */
    addOrganizationMember(id: string, email: string): Promise<AddOrganizationMemberResponse>;
    /**
     *
     ...
     */
    changeOrganizationMemberRole(id: string, memberId: string, role: UserRole): Promise<{
        status: string;
    }>;
    /**
     *
     ...
     */
    rejectOrganizationInvite(id: string): Promise<{
        status: string;
    }>;
    /**
     *
     ...
     */
    removeOrganizationMember(id: string, email: string): Promise<{
        status: string;
    }>;
    /**
     * REVIEWS
     ...
     */
    listReviews(queryData?: ReviewListQueryData): Promise<ListReviewsResponse>;
    /**
     *
     * @summary Reads a Review
     * @param {string} id The id of the Review to read
     */
    readReview(id: string): Promise<ReadReviewResponse>;
    /**
     * PRIVATE TOKENS
     */
    /**
     ...
     */
    createToken(data: TokenCreateData): Promise<CreateTokenResponse>;
    /**
     *
     * @summary Deletes a specified private Token
     * @param {string} id The id of the Token to delete
     */
    deleteToken(id: string): Promise<{
        status: string;
    }>;
    /**
     *
     ...
     */
    listTokens(queryData?: TokenListQueryData): Promise<ListTokensResponse>;
    /**
     * PUBLIC TOKENS
     */
    /**
     ...
     * @param {TokenCreateData} data Data to set in the created Token
     */
    createPublicToken(data: PublicTokenCreateData): Promise<CreatePublicTokenResponse>;
    /**
     *
     * @summary Deletes a specified Public Token
     * @param {string} id The id of the Token to delete
     */
    deletePublicToken(id: string): Promise<{
        status: string;
    }>;
    /**
     *
     ...
     */
    listPublicTokens(queryData?: PublicTokenListQueryData): Promise<ListPublicTokensResponse>;
    /**
     * TRIALS
     */
    /**
     ...
     */
    forkTrial(data: TrialForkData): Promise<ForkTrialResponse>;
    /**
     *
     ...
     */
    listTrials(queryData?: TrialListQueryData): Promise<ListTrialsResponse>;
    /**
     *
     * @summary Reads a Trial
     * @param {string} id The id of the Trial to read
     */
    readTrial(id: string): Promise<ReadTrialResponse>;
    /**
     *
     ...
     */
    updateTrial(id: string, data: TrialUpdateData): Promise<UpdateTrialResponse>;
    /**
     * TRIAL STEPS
     */
    /**
     ...
     */
    createTrialStep(data: TrialStepCreateData): Promise<CreateTrialStepResponse>;
    /**
     *
     ...
     */
    updateTrialStep(id: string, data: TrialStepUpdateData): Promise<UpdateTrialStepResponse>;
    /**
     * UPLOADS
     */
    /**
     ...
     */
    createWorkspace(data: WorkspaceCreateData): Promise<CreateWorkspaceResponse>;
    /**
     *
     ...
     */
    listWorkspaces(queryData?: WorkspaceListQueryData): Promise<ListWorkspacesResponse>;
    /**
     *
     * @summary Reads a Workspace
     * @param {string} id The id of the Workspace to read
     */
    readWorkspace(id: string): Promise<ReadWorkspaceResponse>;
    /**
     *
     ...
     */
    updateWorkspace(id: string, data: WorkspaceUpdateData): Promise<UpdateWorkspaceResponse>;
}
export {};
